...
// ye bass plan mode ke plan ka schema hai ke ess format mein output chiya humko.
...
// ye sara hamra tools aa gaye jinka access hum de raha hai llm ko while jab hum plan mode ke andar hai
...
// ye ho gaya hmara sys instruction type thing jo ke humm llm ko de raha hoga jise ke vo or accha se behave kare as a planner and ess kaa andar humm current code base ka access dega llm ko and uska sath sath web ka bhi access de ga jiske ke llm web scrapping kar sake and web scrapping ke liya yaha pr humm use kare ge "firecrawl". 
...
//   ye actuall logic hai jo ke plan generate kare ga : 
...
//   ye hai hamra web scrapping wala part
