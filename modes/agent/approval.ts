...
// basically apne changes jo humm ne stagging mein abhi rakh rakha hai unko file system mein apply karne ke leya we need a package that is "diff" jiske through humm changes ko apply kar raha hota hai from stagging area to actual file system mein.
